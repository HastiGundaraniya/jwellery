                    ...
                    <div className="row text-center">
                        <div className="col-sm-3 ">
                            <div className="well pt-4 pb-4">
                                ...
                                <Link to="/professor"><button className="btn btn-primary">View</button></Link>
                            </div>
                        </div>
                        <div className="col-sm-3">
                            <div className="well pt-4 pb-4">
                                <h4>Weekly Attendance Report</h4>
                                <Link to="/week"><button className="btn btn-primary">View</button></Link>
                            </div>
                        </div>
                        <div className="col-sm-3">
                            <div className="well pt-4 pb-4">
                                <h4>Student Attendance Report</h4>
                                <Link to="/allSReport"><button className="btn btn-primary">View</button></Link>
                            </div>
                        </div>
                        <div className="col-sm-3">
                            <div className="well pt-4 pb-4">
